...
extern const std::string ACTION_SLIDE_MAINMENU;
extern const std::string ACTION_SLIDE_NEWMENU;
extern const std::string ACTION_SLIDE_OPTIONSMENU;
extern const std::string ACTION_SLIDE_STARTGAME;
extern const std::string ACTION_STARTGAME_EASY;
extern const std::string ACTION_STARTGAME_HARD;
