...
//	setBaseColor(COLOR_BLACK);//@TODO review colors
//	setFont(FontManager::get(FONT_DEFAULT));//@todo review font used.
...
//	add(&mSprite);
//
//	mTextBox.setFont(FontManager::get(FONT_DEFAULT));//@todo need to implement a dialog font, a text font (true type)
//	mTextBox.setOpaque(false);
//	mTextBox.setEditable(false);
//	mTextBox.setFocusable(false);
//	add(&mTextBox);
//
//	mContinueText.setFont(FontManager::get(FONT_DEFAULT));// @todo need to implement a subtext font, for minor notes and such (true type, same as FONT_TEXT but smaller pointsize)
